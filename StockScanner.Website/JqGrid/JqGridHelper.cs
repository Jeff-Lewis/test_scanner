...
namespace StockScanner.Website.JqGrid
{
    ...
    public class Grid
    {
        ...
        public override string ToString()
        {
            ...
            if(this._toolbar != null && this._toolbar.Value)
            {
                script.AppendLine("jQuery('#" + this._id + "').jqGrid('navGrid',\"#" + this._pager + "\",{edit:true,add:true,del:true,search:false,refresh:true}); ");
            }
            // Search toolbar
